...
\begin{tabular}{|l||c|p{0.1\textwidth}|p{0.6\textwidth}|}
\hline
...
\def\arraystretch{1.5}
\begin{tabular}{|l||c|p{0.2\textwidth}|p{0.5\textwidth}|}
\hline
Particle & Mass & Lifetime & Discovery\\
\hline
\hline
...
\def\arraystretch{1.5}
\begin{tabular}{|l||c|c|p{0.15\textwidth}|p{0.55\textwidth}|}
\hline
...
\embedimgw{figs/nnpotential.png}{0.7}
\begin{itemize}
...
\embedimgw{figs/ZvsN.png}{.6}
\subsubsection{Liquid drop model}
\embedimgw{figs/bindingenergy.png}{.5}
\begin{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \embedimgw{figs/fermigasmodel.png}{.8}
...
\begin{itemize}
  ...
  \item Mostly $^4$He, plus some \is{3}{He}, D, \is{7}{Li}
  \item $T\sim 1~\mev$
  ...
  \begin{itemize}
    ...
    \item \is{7}{Le} measurement is in tension with BBN prediction and other light elements
  \end{itemize}
  \item \is{4}{He} was produced earlier and in greater abundance than D because D has low binding energy (2.2~\mev). Therefore, $\gamma$s at thermal eq. could dissociate D easily. Need to wait for Universe to cool to $T\sim 0.1~\mev$
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item The \is{12}{C} is in a $0^+$ excited state, so the $Q$ value is $\sim300~\mev$
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \embedimgw{figs/qcdphases.png}{.6}
